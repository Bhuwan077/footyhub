// scripts/populatePlayersEPL.js
// Fetches lineups for finished EPL matches from Highlightly
// and stores every player (starters + substitutes) in the players table.
...
async function main() {
  try {
    ...
    console.error('Error populating EPL players:', err.message);
  } finally {
    await pool.end();
  }
}
